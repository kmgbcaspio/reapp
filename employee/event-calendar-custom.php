...
<body>
    ...
    <div class="wrapper p-4">
        <div class="header mb-4">
            <h3>Event Calendar (Custom)</h3>
            <ol class="breadcrumb bg-transparent small p-0">
                <li class="breadcrumb-item"><a href="./dashboard.php">Home</a></li>
                <li class="breadcrumb-item">Event Calendar (Custom)</li>
            </ol>
        </div>
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-none">
                           <!-- Event calendar custom Datapage-->
                        </div>
                        <div class="mt-3 mb-5" id="cb-calendar"></div>
    ...
    <script src="../assets/js/disp-event-calendar.js"></script>
    
    <script>
        $(document).ready(function() {
            activePage('calendar-custom');
        });
    </script>
</body>
</html>